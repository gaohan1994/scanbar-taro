      ...
      >
        ...
        >
          <View className={`${cssPrefix}-item-top-left`}>
            ...
            <Text className={`${cssPrefix}-item-top-left-info`}>满{coupon.couponVO && coupon.couponVO.threshold}可用</Text>
          </View>
          <View className={`${cssPrefix}-item-top-right`}>
            ...
            >
              ...
              >
                {`${dayJs(coupon.createTime).format('MM/DD')}~${dayJs(coupon.effectiveTime).format('MM/DD')}`}
              </Text>
              <Image
        ...
        {!!showMore && (
          <View className={`${cssPrefix}-item-bottom`}>
            <Text className={`${cssPrefix}-item-bottom-info`}>
              1.优惠券满{coupon.couponVO && coupon.couponVO.threshold || 0}元减
