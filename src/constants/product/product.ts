...
export declare namespace ProductInterface {
  ...
  type RECEIVE_PRODUCT_PAGING_LIST = string;
  ...
  interface ReducerInterface {
    ...
    RECEIVE_PRODUCT_PAGING_LIST: RECEIVE_PRODUCT_PAGING_LIST
...
interface ProductInterfaceMap {
  ...
  productInfoGetList(
    params?: ProductInterface.ProductInfoGetListFetchFidle
  ): string;
  ...
  productInfoScanGet(
    params: ProductInterface.ProductInfoScanGetFetchFidle
  ): string;
  productInfoScan(
    params: ProductInterface.ProductInfoScanGetFetchFidle
  ): string;
...
class ProductInterfaceMap {
  ...
  public productInfoGetList = (
    params?: ProductInterface.ProductInfoGetListFetchFidle
  ) => {
    return `/product/productInfo/getList${
