  ...
  render() {
    return (
      <View className="container container-color">
        ...
        <View className={`${cssPrefix}-box`}>{this.renderSearch()}</View>
  ...
  private renderContainer = () => {
    ...
    return (
      <View className={`${cssPrefix}-container`}>
        {value === "" && <View>{this.renderTime()}</View>}
        <ScrollView
          scrollY={true}
        ...
        >
          {!!value &&
            (orderSearchList.length > 0 ? (
              orderSearchList.map(orderDetail => {
                return (
                  <OrderItem
          ...
          {!value && !hasMore && orderList.length > 10 && (
  ...
  private renderTime = () => {
    ...
    return (
      <View className={`${cssPrefix}-time`}>
        <View
          className={`${cssPrefix}-time-box ${cssPrefix}-time-box-left`}
        ...
        <Picker mode="date" onChange={this.onDateChange} value={date}>
          <View className={`${cssPrefix}-time-date`}>
            <Image
              src="//net.huanmusic.com/weapp/v1/icon_rili.png"
              className={`${cssPrefix}-time-rili`}
            />
            <Text>{date}</Text>
          </View>
        </Picker>
        <View
          className={`${cssPrefix}-time-box ${cssPrefix}-time-box-right`}
          ...
          <View className={`inventory-select-item`}>
            ...
            <View className={"inventory-select-item-box"}>
              ...
              <View
                ...
                className={classnames("inventory-select-item-button", {
                  "inventory-select-item-button-active":
                    selectStatus.length === 1 && selectStatus.some(s => s === 0)
                })}
              >
                交易成功
              </View>
              <View
                ...
                className={classnames("inventory-select-item-button", {
                  "inventory-select-item-button-active":
                    selectStatus.length === 1 && selectStatus.some(s => s === 1)
                })}
              >
                交易失败
              </View>
          ...
          <View className={`inventory-select-item`}>
            ...
            <View className={"inventory-select-item-box"}>
              ...
              <View
                ...
                className={classnames("inventory-select-item-button", {
                  "inventory-select-item-button-active":
                    selectTypes.length === 1 && selectTypes.some(t => t === 0)
                })}
              >
                销售单
              </View>
              <View
                ...
                className={classnames("inventory-select-item-button", {
                  "inventory-select-item-button-active":
                    selectTypes.length === 1 && selectTypes.some(t => t === 1)
                })}
              >
                退货单
              </View>
