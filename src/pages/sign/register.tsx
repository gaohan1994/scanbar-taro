 ...
 * @Last Modified time: 2020-05-21 15:39:41
 */
      ...
      {step === 1 ? (
            ...
            return (
              <View className="sign-card-input" key={form.title}>
                <View className={`${cssPrefix}-input-box`}>
                  <View className={`${cssPrefix}-input-title`}>
                    {form.title}
                  </View>
        ...
        <View className="sign-card sign-card-register2">
          ...
          <Picker
            mode="selector"
            range={
              merchantProp && (merchantProp as any[]).length > 0
                ? merchantProp.map(item => item.dictLabel)
                : []
            }
              ...
              <View className={`${cssPrefix}-input-box`}>
                ...
                <View className={`${cssPrefix}-input-container`}>
                  <View className={`${cssPrefix}-input-box-input`}>
                    {`${
                      merchantProp && merchantProp.length > 0
                        ? merchantProp[business].dictLabel
                        : "请选择所属行业"
                    }`}
                  </View>
                </View>
          ...
          <View className="sign-bar">
            <View className="sign-bar-active" onClick={() => setStep(1)}>
              上一步
            </View>
